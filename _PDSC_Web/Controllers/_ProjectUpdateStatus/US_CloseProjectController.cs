...
{
    public class US_CloseProjectController : Controller
    {
        _US_CloseProject close = new _US_CloseProject();
        ...
        public JsonResult GetPlateDate()
        {
            ...
            var result = close.Get_Plan_by_Stage(MFG_No, "SM_0009");
        ...
        public JsonResult GetTable_Prepare()
        {
            ...
            var result = close.GetList_Task_by_Stage(MFG_No, "SM_0009");
            return Json(result);
        }
        ...
        public JsonResult ToTransection(string tranNo, string TaskName)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Transaction", "US_CloseProject")
            });
        }
        #endregion
        ...
        public JsonResult GetTable_Transection(string TransectionNo)
        {
            ...
            var result = close.GetList_Transaction_by_Task(MFG_No, TransectionNo);
        ...
        public JsonResult ToEdit(string TT_Code)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Edit", "US_CloseProject")
            });
        }
        ...
        [SessionTimeout]
        [HttpPost]
        public ActionResult CreateClose(Create_UpdateStatusVM Data)
        {
            get_roles_fn();
            if (ViewBag.GetRoles != "Role_US29")
                return RedirectToAction("Logout", "Login");
            ...
            var resultSave = close.Save_Task_Transaction_by_Task(obj);
            ...
            if (resultSave)
            {
                ...
                if (ListImg.Count > 0)
                {
                    for (int i = 0; i < ListImg.Count; i++)
                    {
                        ...
                        close.Save_Image_Transaction_by_Task(ImgObj);
                    }
                }
                //add file to DB
                if (ListFile.Count > 0)
                ...
                _writelog.WriteLog("Create", "US Close Project", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Create", "US Close Project", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
            //  return RedirectToAction("Transaction", "US_CloseProject");
            return RedirectToAction("Index", "US_CloseProject");
        }
        [SessionTimeout]
        [HttpPost]
        public ActionResult EditClose(Edit_UpdateStatusVM Data)
        {
            get_roles_fn();
            if (ViewBag.GetRoles != "Role_US29")
                return RedirectToAction("Logout", "Login");
            ...
            for (int i = 0; i < ListImgDelete.Count; i++)
            {
                if (ListImgDelete[i] != "") //delete iumage from Database
                {
                    ...
                    close.Delete_Image_Transaction_by_Task(deleteobj);
                }
            }
            ...
            if (resultSave)
            {
                ...
                _writelog.WriteLog("Edit", "US Close Project", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Edit", "US Close Project", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
        ...
        public JsonResult GetDropDownResult()
        {
            ...
            var result = close.GetList_Result_by_Task(TaskCode);
        ...
        public JsonResult GetDropDownProblem()
        {
            ...
            var result = close.GetList_Problem_by_Task(TaskCode);
        ...
        public JsonResult Edit_GetData(Guid TransectionCode)
        {
            ...
            var result = close.GetList_Transaction_by_Task(MFG_No, TaskCode)
        ...
        public JsonResult Edit_GetImg(Guid TransectionCode)
        {
            ...
            var result = close.GetList_Image_Transaction_by_Task(obj)
        ...
        private void get_roles_fn()
        {
            ...
            var s_Roles = _lstGetRoles.Where(a => a.ROLE_Code == "Role_US29" || a.ROLE_Code == "Role_US30").FirstOrDefault();
            if (s_Roles != null)
