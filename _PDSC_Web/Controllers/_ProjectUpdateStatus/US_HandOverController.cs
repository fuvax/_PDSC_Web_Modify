...
{
    public class US_HandOverController : Controller
    {
        // GET: US_HandOver
        _US_HandOver handover = new _US_HandOver();
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.PageName = "Stage: Hand Over";
            get_roles_fn();
        ...
        public JsonResult GetPlateDate()
        {
            ...
            var result = handover.Get_Plan_by_Stage(MFG_No, "SM_0007");
        ...
        public JsonResult GetTable_Prepare()
        {
            ...
            var result = handover.GetList_Task_by_Stage(MFG_No, "SM_0007");
            return Json(result);
        }
        ...
        public JsonResult ToTransection(string tranNo, string TaskName)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Transaction", "US_HandOver")
            });
        }
        #endregion
        ...
        public JsonResult GetTable_Transection(string TransectionNo)
        {
            ...
            var result = handover.GetList_Transaction_by_Task(MFG_No, TransectionNo);
        ...
        public JsonResult ToEdit(string TT_Code)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Edit", "US_HandOver")
            });
        }
        ...
        [SessionTimeout]
        [HttpPost]
        public ActionResult CreateHandOver(Create_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            var resultSave = handover.Save_Task_Transaction_by_Task(obj);
            ...
            if (resultSave)
            {
                ...
                if (ListImg.Count > 0)
                {
                    for (int i = 0; i < ListImg.Count; i++)
                    {
                        ...
                        handover.Save_Image_Transaction_by_Task(ImgObj);
                    }
                }
                //add file to DB
                if (ListFile.Count > 0)
                ...
                _writelog.WriteLog("Create", "US Hand Over", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Create", "US Hand Over", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
            //  return RedirectToAction("Transaction", "US_HandOver");
            return RedirectToAction("Index", "US_HandOver");
        }

        [SessionTimeout]
        [HttpPost]
        public ActionResult EditHandOver(Edit_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            for (int i = 0; i < ListImgDelete.Count; i++)
            {
                if (ListImgDelete[i] != "") //delete iumage from Database
                {
                    ...
                    handover.Delete_Image_Transaction_by_Task(deleteobj);
                }
            }
            ...
            if (resultSave)
            {
                ...
                _writelog.WriteLog("Edit", "US Hand Over", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Edit", "US Hand Over", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
        ...
        public JsonResult GetDropDownResult()
        {
            ...
            var result = handover.GetList_Result_by_Task(TaskCode);
        ...
        public JsonResult GetDropDownProblem()
        {
            ...
            var result = handover.GetList_Problem_by_Task(TaskCode);
        ...
        public JsonResult Edit_GetData(Guid TransectionCode)
        {
            ...
            var result = handover.GetList_Transaction_by_Task(MFG_No, TaskCode)
        ...
        public JsonResult Edit_GetImg(Guid TransectionCode)
        {
            ...
            var result = handover.GetList_Image_Transaction_by_Task(obj)
        ...
        private void get_roles_fn()
        {
            ...
            var s_Roles = _lstGetRoles.Where(a => a.ROLE_Code == "Role_US25" || a.ROLE_Code == "Role_US26").FirstOrDefault();
            if (s_Roles != null)
