...
{
    public class US_InstallController : Controller
    {
        _US_Install install = new _US_Install();
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.PageName = "Stage: Install";
            get_roles_fn();
        ...
        public JsonResult GetPlateDate()
        {
            ...
            var result = install.Get_Plan_by_Stage(MFG_No, "SM_0003");
        ...
        public JsonResult GetTable_Prepare()
        {
            ...
            var result = install.GetList_Task_by_Stage(MFG_No, "SM_0003");
            return Json(result);
        }
        ...
        public JsonResult ToTransection(string tranNo, string TaskName)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Transaction", "US_Install")
            });
        }
        #endregion
        ...
        public JsonResult GetTable_Transection(string TransectionNo)
        {
            ...
            var result = install.GetList_Transaction_by_Task(MFG_No, TransectionNo);
        ...
        public JsonResult ToEdit(string TT_Code)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Edit", "US_Install")
            });
        }
        ...
        [SessionTimeout]
        [HttpPost]
        public ActionResult CreateInstall(Create_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            var resultSave = install.Save_Task_Transaction_by_Task(obj);
            ...
            if (resultSave)
            {
                ...
                if (ListImg.Count > 0)
                {
                    for (int i = 0; i < ListImg.Count; i++)
                    {
                        ...
                        install.Save_Image_Transaction_by_Task(ImgObj);
                    }
                }
                //add file to DB
                if (ListFile.Count > 0)
                ...
                _writelog.WriteLog("Create", "US Install", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Create", "US Install", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
            //  return RedirectToAction("Transaction", "US_Install");
            return RedirectToAction("Index", "US_Install");
        }

        [SessionTimeout]
        [HttpPost]
        public ActionResult EditInstall(Edit_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            for (int i = 0; i < ListImgDelete.Count; i++)
            {
                if (ListImgDelete[i] != "") //delete iumage from Database
                {
                    ...
                    install.Delete_Image_Transaction_by_Task(deleteobj);
                }
            }
            ...
            if (resultSave)
            {
                ...
                _writelog.WriteLog("Edit", "US Install", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Edit", "US Install", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
        ...
        public JsonResult GetDropDownResult()
        {
            ...
            var result = install.GetList_Result_by_Task(TaskCode);
        ...
        public JsonResult GetDropDownProblem()
        {
            ...
            var result = install.GetList_Problem_by_Task(TaskCode);
        ...
        public JsonResult Edit_GetData(Guid TransectionCode)
        {
            ...
            var result = install.GetList_Transaction_by_Task(MFG_No, TaskCode)
        ...
        public JsonResult Edit_GetImg(Guid TransectionCode)
        {
            ...
            var result = install.GetList_Image_Transaction_by_Task(obj)
        ...
        private void get_roles_fn()
        {
            ...
            var s_Roles = _lstGetRoles.Where(a => a.ROLE_Code == "Role_US17" || a.ROLE_Code == "Role_US18").FirstOrDefault();
            if (s_Roles != null)
