...
{
    public class US_TestingController : Controller
    {
        _US_Testing testing = new _US_Testing();
        ...
        {
            if ((Session["Stage"].ToString() == "Delivery" || Session["Stage"].ToString() == "Power Supply" || Session["Stage"].ToString() == "") 
                && Host.Fix_Work_Approve == 1)
            {
                return RedirectToAction("Logout", "Login");
            }
            ViewBag.PageName = "Stage: Testing";
            get_roles_fn();
        ...
        public JsonResult GetPlateDate()
        {
            ...
            var result = testing.Get_Plan_by_Stage(MFG_No, "SM_0005");
        ...
        public JsonResult GetTable_Prepare()
        {
            ...
            var result = testing.GetList_Task_by_Stage(MFG_No, "SM_0005");
            return Json(result);
        }
        ...
        public JsonResult ToTransection(string tranNo, string TaskName)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Transaction", "US_Testing")
            });
        }
        #endregion
        ...
        public JsonResult GetTable_Transection(string TransectionNo)
        {
            ...
            var result = testing.GetList_Transaction_by_Task(MFG_No, TransectionNo);
        ...
        public JsonResult ToEdit(string TT_Code)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Edit", "US_Testing")
            });
        }
        ...
        [SessionTimeout]
        [HttpPost]
        public ActionResult CreateTesting(Create_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            var resultSave = testing.Save_Task_Transaction_by_Task(obj);
            ...
            if (resultSave)
            {
                ...
                if (ListImg.Count > 0)
                {
                    for (int i = 0; i < ListImg.Count; i++)
                    {
                        ...
                        testing.Save_Image_Transaction_by_Task(ImgObj);
                    }
                }
                //add file to DB
                if (ListFile.Count > 0)
                ...
                _writelog.WriteLog("Create", "US Testing", Session["MFG"].ToString() + " - " + TaskNo, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Create", "US Testing", Session["MFG"].ToString() + " - " + TaskNo + " - " + resultSave, true, Session["User_EmpName"] as string);
            }
            // return RedirectToAction("Transaction", "US_Testing");
            return RedirectToAction("Index", "US_Testing");
        }
        [SessionTimeout]
        [HttpPost]
        public ActionResult EditTesting(Edit_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            for (int i = 0; i < ListImgDelete.Count; i++)
            {
                if (ListImgDelete[i] != "") //delete iumage from Database
                {
                    ...
                    testing.Delete_Image_Transaction_by_Task(deleteobj);
                }
            }
            ...
            if (resultSave)
            {
                ...
                _writelog.WriteLog("Edit", "US Testing", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Edit", "US Testing", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
        ...
        public JsonResult GetDropDownResult()
        {
            ...
            var result = testing.GetList_Result_by_Task(TaskCode);
        ...
        public JsonResult GetDropDownProblem()
        {
            ...
            var result = testing.GetList_Problem_by_Task(TaskCode);
        ...
        public JsonResult Edit_GetData(Guid TransectionCode)
        {
            ...
            var result = testing.GetList_Transaction_by_Task(MFG_No, TaskCode)
        ...
        public JsonResult Edit_GetImg(Guid TransectionCode)
        {
            ...
            var result = testing.GetList_Image_Transaction_by_Task(obj)
        ...
        private void get_roles_fn()
        {
            ...
            var s_Roles = _lstGetRoles.Where(a => a.ROLE_Code == "Role_US21" || a.ROLE_Code == "Role_US22").FirstOrDefault();
            if (s_Roles != null)
