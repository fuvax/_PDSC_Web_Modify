...
{
    public class US_PowerSupplyController : Controller
    {
        _US_PowerSupply power = new _US_PowerSupply();
        ...
        {
            if ((Session["Stage"].ToString() == "Delivery" || Session["Stage"].ToString() == "") && Host.Fix_Work_Approve == 1)
            {
                return RedirectToAction("Logout", "Login");
            }
            ViewBag.PageName = "Stage: Power Supply";
            get_roles_fn();
        ...
        public JsonResult GetPlateDate()
        {
            ...
            var result = power.Get_Plan_by_Stage(MFG_No, "SM_0004");
        ...
        public JsonResult GetTable_Prepare()
        {
            ...
            var result = power.GetList_Task_by_Stage(MFG_No, "SM_0004");
            return Json(result);
        }
        ...
        public JsonResult ToTransection(string tranNo, string TaskName)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Transaction", "US_PowerSupply")
            });
        }
        #endregion
        ...
        public JsonResult GetTable_Transection(string TransectionNo)
        {
            ...
            var result = power.GetList_Transaction_by_Task(MFG_No, TransectionNo);
        ...
        public JsonResult ToEdit(string TT_Code)
        {
            ...
            {
                result = "Redirect",
                url = Url.Action("Edit", "US_PowerSupply")
            });
        }
        ...
        [SessionTimeout]
        [HttpPost]
        public ActionResult CreatePower(Create_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            var resultSave = power.Save_Task_Transaction_by_Task(obj);
            ...
            if (resultSave)
            {
                ...
                if (ListImg.Count > 0)
                {
                    for (int i = 0; i < ListImg.Count; i++)
                    {
                        ...
                        power.Save_Image_Transaction_by_Task(ImgObj);
                    }
                }
                //add file to DB
                if (ListFile.Count > 0)
                ...
                _writelog.WriteLog("Create", "US Power Supply", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Create", "US Power Supply", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
            // return RedirectToAction("Transaction", "US_PowerSupply");
            return RedirectToAction("Index", "US_PowerSupply");
        }
        [SessionTimeout]
        [HttpPost]
        public ActionResult EditPower(Edit_UpdateStatusVM Data)
        {
            get_roles_fn();
            ...
            for (int i = 0; i < ListImgDelete.Count; i++)
            {
                if (ListImgDelete[i] != "") //delete iumage from Database
                {
                    ...
                    power.Delete_Image_Transaction_by_Task(deleteobj);
                }
            }
            ...
            if (resultSave)
            {
                ...
                _writelog.WriteLog("Edit", "US Power Supply", Session["MFG"].ToString() + " => " + obj.TT_Code, false, Session["User_EmpName"] as string);
            }
            else
            {
                _writelog.WriteLog("Edit", "US Power Supply", Session["MFG"].ToString() + " => " + obj.TT_Code + " => " + resultSave, true, Session["User_EmpName"] as string);
            }
            // return RedirectToAction("Transaction", "US_PowerSupply");
            return RedirectToAction("Index", "US_PowerSupply");
        }
        ...
        public JsonResult GetDropDownResult()
        {
            ...
            var result = power.GetList_Result_by_Task(TaskCode);
        ...
        public JsonResult GetDropDownProblem()
        {
            ...
            var result = power.GetList_Problem_by_Task(TaskCode);
        ...
        public JsonResult Edit_GetData(Guid TransectionCode)
        {
            ...
            var result = power.GetList_Transaction_by_Task(MFG_No, TaskCode)
        ...
        public JsonResult Edit_GetImg(Guid TransectionCode)
        {
            ...
            var result = power.GetList_Image_Transaction_by_Task(obj)
        ...
        {
            set_lstMainMenu();
            ViewBag.StageName = "Power Supply";
            ...
            var s_Roles = _lstGetRoles.Where(a => a.ROLE_Code == "Role_US19" || a.ROLE_Code == "Role_US20").FirstOrDefault();
            if (s_Roles != null)
